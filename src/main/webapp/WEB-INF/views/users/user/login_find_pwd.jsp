	...
	<div id="find">
		<div style="text-align: center;" id="logo">
			...
			<div class="find_btn_idPwd">
				<input type="button" value="아이디 찾기" onclick="location='<c:url value='/user/findId'/>';" /> 
				<input type="button" value="비밀번호 찾기"   style="font-weight: bold;" onclick="location='<c:url value='/user/findPw'/>';" />
			</div>
					...
					<div class="phone_identify" id="identify_board">
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" aria-label="Default"
								aria-describedby="inputGroup-sizing-default" name="user_name"
								size="20" id="user_name1">
						</div>
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" id="user_phone" aria-label="Default"
								aria-describedby="inputGroup-sizing-default" name="user_phone"
								size="30" placeholder="하이픈(-)형식으로  11자리의 전화번호를 입력해주세요">
						</div>
					</div>
				...
				<div>
					...
					<div class="email_identify" style="display: none;"
						...
						<div class="input-group mb-3">
							...
							<input type="text" id="user_name2" class="form-control" aria-label="Default"
								aria-describedby="inputGroup-sizing-default" name="user_name"
								size="20">
						</div>
						...
						<div class="input-group mb-3">
							...
							<input type="text" id="user_id2" class="form-control" aria-label="Default"
								aria-describedby="inputGroup-sizing-default" name="user_id"
								size="20">
						</div>
						...
						<div class="input-group mb-3">
							...
							<input type="text" id="user_mail_id" class="form-control" aria-label="Username"
								aria-describedby="basic-addon1" name="user_mail_id" size="15">
							<div>
								<span class="input-group-text" id="basic-addon1">@</span>
							</div>
							<input type="text" class="form-control" placeholder="example.com"
								aria-label="Username" aria-describedby="basic-addon1"
								name="user_mail_domain" size="15">
