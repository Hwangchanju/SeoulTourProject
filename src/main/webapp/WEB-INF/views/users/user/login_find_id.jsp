	...
	<div id="find">
		<div style="text-align: center;" id="logo">
			...
			<div class="find_btn_idPwd">
				<input type="button" value="아이디 찾기" style="font-weight: bold;"
					onclick="location='<c:url value='/user/findId'/>';" />
				<input type="button" value="비밀번호 찾기"
					onclick="location='<c:url value='/user/findPw'/>';" />
			</div>
			...
			<form action="<c:url value='/user/findId'/>" method="post">
					...
					<div class="phone_identify" id="identify_board">
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" aria-label="Default"
								aria-describedby="inputGroup-sizing-default" name="user_name" id="user_name1"
								size="20">
						</div>
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" aria-label="Default"
								aria-describedby="inputGroup-sizing-default" name="user_phone" id="user_phone"
					...
					<div class="email_identify" style="display: none;"
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" aria-label="Username"
								aria-describedby="basic-addon1" name="user_mail_id" size="15" id="user_mail_id">
							<div>
				...
				<br> <br> <input type="submit" value="아이디 찾기"
					class="find_btn" />
			</form>
		</div>
	</div>
