		...
		<div style="text-align: center;" id="logo">
			...
			<div class="find_btn_idPwd">
				<input type="button" value="아이디 찾기" style="font-weight: bold;"
					onclick="location='<c:url value='/admin/findId'/>';" />
				<input type="button" value="비밀번호 찾기"
					onclick="location='<c:url value='/admin/findPw'/>';" />
			</div>

			<form action="<c:url value='/admin/findId'/>" method="post">
				<div>
