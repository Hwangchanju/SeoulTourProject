...
<body
  ...
  <path
			...
			<ul class="nav nav-pills flex-column mb-auto">
				...
				<li class="nav-item"><a href="<c:url value='/admin/exhibition/exhibition/1'/>" class="nav-link active"
			...
			<div class="card"
				...
				<div class="card-body">
					<a href="https://korean.visitseoul.net/${list_url[i]}"
						...
						<p class="card-text" style="text-align: center; font-size:13px;">${list_date[i]}</p>
					</a>
				</div>
			</div>
		</c:forEach>
	...
	<div class="btn-group me-2 center" role="group"
		...
		<c:forEach begin="1" end="${paging_cnt }" var="p">
			<button type="button" class="btn btn-primary"
				onclick="location.href='<c:url value='/admin/exhibition/exhibition/${p }'/>';">${p }</button>
		</c:forEach>
	</div>
